export namespace WeaponIconResolver {
    export const resolve = (weaponName: string): string | null => {
        ...
        const map: { [weaponName: string]: string } = {
            ...
            revolver: "http://vignette.wikia.nocookie.net/cswikia/images/d/d9/Revolver_hud_csgo.png/revision/latest/scale-to-width-down/400",
            ...
            mp5sd: "https://vignette.wikia.nocookie.net/cswikia/images/5/58/Icon_mp5sd.png/revision/latest?cb=20170323122229",
        ...
        return map[weaponName.replace("weapon_", "")] || null;
    };
}
